...
class Problem0055(EulerProblem):
    """
    ...
    arrive at a palindrome. Although no one has proved it yet, it is thought
    ...
    number. Due to the theoretical nature of these numbers, and for the purpose
    ...
    example is 4994. How many Lychrel numbers are there below ten-thousand?
