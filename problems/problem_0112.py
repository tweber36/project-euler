...
class Problem0112(EulerProblem):
    """
    ...
    reach 21780 the proportion of bouncy numbers is equal to 90%. Find the least
    number for which the proportion of bouncy numbers is exactly 99%.
    """
    problem_id = 112
    simple_input = 0
    simple_output = 1
