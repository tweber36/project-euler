...
class Problem0149(EulerProblem):
    """
    ...
    anti-diagonal) is 16 (= 8 + 7 + 1).  −25329−6513273−18−4  8 Now, let us
    ...
    (modulo 1000000) − 500000. For 56 ≤ k ≤ 4000000, sk = [sk−24 + sk−55 +
    1000000] (modulo 1000000) − 500000. Thus, s10 = −393027 and s100 = 86613.
    ...
    the second row, and so on. Finally, find the greatest sum of (any number of)
    adjacent entries in any direction (horizontal, vertical, diagonal or anti-
    diagonal).
    """
    problem_id = 149
    simple_input = 0
