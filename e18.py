triangle = [75, [95, 64], [17, 47, 82], [18, 35, 87, 10], [20, 4, 82, 47, 65], [19, 1, 23, 75, 3, 34], \
            ...
            [70, 11, 3, 28, 77, 73, 17, 78, 39, 68, 17, 57], [91, 71, 52, 38, 17, 14, 91, 43, 58, 50, 27, 29, 48], \
            [63, 66, 4, 68, 89 ,53, 67, 30, 73, 16, 69, 87, 40, 31], \
            [4, 62, 98, 27, 23, 9, 70, 98, 73, 93, 38, 53, 60, 4, 23]]

while len(triangle) >= 3:
    for i, elt in enumerate(triangle[-2]):
        print(i)
...
if triangle[1][0] >= triangle[1][1]:
    print(triangle[0] + triangle[1][0])
else:
    print(triangle[0] + triangle[1][1])
