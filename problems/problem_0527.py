...
class Problem0527(EulerProblem):
    """
    ...
    search. For example, B(6) = 2.33333333 and R(6) = 2.71666667 when rounded to
    8 decimal places. Find R(1010) − B(1010) rounded to 8 decimal places.
    """
    problem_id = 527
    simple_input = 0
    simple_output = 1
