...
class Problem0111(EulerProblem):
    """
    ...
    1151, 1171, 1181, 1511, 1811, 2111, 4111, 8111 We shall say that M(n, d)
    ...
    same way we obtain the following results for 4-digit primes.  Digit, d M(4,
    d) N(4, d) S(4, d) 0 2 13 67061 1 3 9 22275 2 3 1 2221 3 3 12 46214 4 3 2
    8888 5 3 1 5557 6 3 1 6661 7 3 9 57863 8 3 1 8887 9 3 7 48073  For d = 0 to
    9, the sum of all S(4, d) is 273700. Find the sum of all S(10, d).
    """
    problem_id = 111
    simple_input = 0
    simple_output = 1
